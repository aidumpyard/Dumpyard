...
Sub RefreshAllPivotTables()
    ...
    For i = 2 To lastRow
        ...
        ThisWorkbook.Sheets("Summary").Range("C9").Value = Format(percentageComplete, "0.00") & "%"
...
ErrorHandler:
        ...
        ' Close the input and data files if they are open
        On Error Resume Next
        If Not inputWB Is Nothing Then
            If inputWB.Saved = False Then inputWB.Close SaveChanges:=False
        End If
        If Not dataWB Is Nothing Then
            If dataWB.Saved = False Then dataWB.Close SaveChanges:=False
        End If
        On Error GoTo 0
