...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(id='common-columns-dropdown', multi=True, placeholder="Select common columns to exclude"),
...
def update_data_frames(left_file, right_file, show_delta, excluded_columns):
    if left_file and right_file:
        ...
        if show_delta:
            ...
            return html.Pre(left_df.to_string()), html.Pre(delta_df.to_string()), dropdown_options
