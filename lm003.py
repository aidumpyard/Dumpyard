...
def process_sheet(sheet_name, df):
    ...
    # Store original Entity and CEntity values
    df["Original_Entity"] = df["Entity"]
    df["Original_CEntity"] = df["CEntity"]
    ...
    # Restore original Entity and CEntity values
    df["Entity"] = df["Original_Entity"]
    df["CEntity"] = df["Original_CEntity"]

    # Drop temporary columns
    df = df.drop(columns=["Original_Entity", "Original_CEntity"], errors="ignore")
