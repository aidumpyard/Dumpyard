...
below_min = compressed_pivot_table.loc[compressed_pivot_table.index.get_level_values('range2') < range_min].sum()
above_max = compressed_pivot_table.loc[compressed_pivot_table.index.get_level_values('range1') > range_max].sum()
compressed_pivot_table = compressed_pivot_table[(compressed_pivot_table.index.get_level_values('range1') >= range_min) & (compressed_pivot_table.index.get_level_values('range2') <= range_max)]
