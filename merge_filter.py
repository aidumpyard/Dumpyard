...
merged_df = merged_df[
    (merged_df['received'] >= merged_df['Date']) & (merged_df['received'] <= merged_df['Date'] + pd.Timedelta(days=2))
]

# Step 5: Select final columns
output_df = merged_df[['Date', 'Entity', 'CpEntity', 'Amount', 'Status']]
